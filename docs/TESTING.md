...
剩余发行门的唯一父卡归属、可一次执行的实操步骤、候选三要素标识（固定 40 位 commit、DMG SHA256、helper SHA256）、集中授权与环境缺口清单见发行实测准备清单（ISS-076，2026-09-19 内部记录，未随公开库分发）。
